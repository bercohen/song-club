...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference('Performer.count') do
      post performers_url, params: { performer: { concert_id: @performer.concert_id, user_id: @performer.user_id } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { concert_id: @performer.concert_id, user_id: @performer.user_id } }
