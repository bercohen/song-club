...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { adress: @concert.adress, date: @concert.date, goup_id: @concert.goup_id, user_id: @concert.user_id, venue: @concert.venue } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { adress: @concert.adress, date: @concert.date, goup_id: @concert.goup_id, user_id: @concert.user_id, venue: @concert.venue } }
